  ...
  <div id="wrap" class="boxed">
   ...
   <div class="style-2 home s-2 bottom-3">
     <div class="container clearfix">
        ...
        <p>The proposed project is a smart parking booking system that provides an easy way of reserving a parking space online using web portal. It overcomes the problem of finding a parking space in universities, institute, government offices, market areas etc  that unnecessary consumes time. Hence, this project offers a web based portal reservation system where any user can view various parking spaces and select nearby or specific area of their choice to view whether space is available or not. If the booking space is available, then user can book it for specific time slot.The booked space will be marked and will not be available for anyone else for the specified time. This system provides an additional feature of cancelling the bookings. User can cancel their reserved space anytime. User can also view previous parking booking details using the web portal.</p>
